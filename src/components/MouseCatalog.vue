<template>
    <div>
        <br>
        <div class="row" v-for="rowIdx in Math.ceil(data_mouse.length / 3)" :key="rowIdx">
            <div class="col-sm-4" v-for="item in data_mouse.slice(3 * (rowIdx - 1), 3 * rowIdx)" :key="item.id">
                <div class="card"> 
